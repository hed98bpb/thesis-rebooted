...
the other two sets are those who pass left and those who pass right of $f$, see figurue \ref{fig:wef}. The simulation process continues with the left and right 
...
\begin{figure}[H]
	...
	\caption{A visualisation of the three groups of bisectors that can occur in the calculation of $W(e,f)$. One going left of $f$, one going right of $f$, these two groups are marked with gray, and the middle group which is the group $W(e,f)$ consists of.}
	\label{fig:wef}
\end{figure}

...
\begin{description}
	\item[Chapter 2] We descripe a simple $O(n^3)$ algorithm for contructing a
		...
		theoratical time.
	\item [Chapter 3] overview of bla blabla
	\item [Chapter 4] overview of bla blabla
	\item [Chapter 5] overview of bla blabla
	\item [Chapter 6] overview of bla blabla
	\item [Chapter 7] overview of bla blabla
	\item [Chapter 8] overview of bla blabla

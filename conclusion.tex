...
of it seems to make this a non trivial task. With such an implementation it would be interesting to measure performance
and compare this to the naive $O(n^3)$ solution.

Also of interest would be the an expansion of the bound of complexity for $SPM_k$ and general lower bound of a 
shortest $k$-path computation

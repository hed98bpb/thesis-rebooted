...
be a grid with orthogonal cells\peter{define}. Key idea behind the growth process is, each data point $p$ in
...
intersect). Thus There are at most six cells within distance $|e|$ of any edge $e$. \\ \peter{maybe pic}
...
\peter{pic of dual graph process}
